...
DD_belatedPNG.fix('#site-id h1 img,#cms-menu-help,#cms-menu-help p,#user-status,.window-content .tab-menu ul.tab-index li,.window-content .tab-menu ul.tab-index li a,p.close'); 
}
